...
export class GraphQLService {
  ...
  private static getGraphqlUrl(rpcUrl: string): string | null {
   ...
   */
  public static async getAddressBalanceEffects(
    address: string,
    rpcUrl: string
  ): Promise<TransactionBalanceEffect[] | null> {
    const graphqlUrl = this.getGraphqlUrl(rpcUrl);
   ...
   */
  public static async getTransactionTimestamps(
    digests: string[],
    rpcUrl: string
    ...
    try {
      ...
      return {
        ...
        effects: {
          ...
          executedEpoch: effects?.epoch?.epochId !== undefined ? String(effects.epoch.epochId) : undefined,
