...
import { SmoothScroll, useSmoothScroll } from '@/components/unlumen-ui/scroll-animation';
...
export function MainLayout() {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      if (connected) {
        ...
        await Promise.all([fetchStatus(), fetchAddresses(), fetchEnvironments()]);
      }
    };
    init();
  ...
  return (
    <main className="h-screen w-screen bg-background overflow-hidden flex relative" role="main">
