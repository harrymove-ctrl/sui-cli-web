...
export type FileTreeElement = {
  ...
  defaultOpen?: boolean;
  /** Makes a file node interactive (cursor pointer + click handler). */
  onSelect?: () => void;
  /** Marks a file node as the current selection (e.g. active route). */
  active?: boolean;
};
  ...
  return (
    ...
    >
      <div
        ...
        style={
          node.active
            ? { color: highlightColor, backgroundColor: `${highlightColor}1a` }
            : node.highlight
