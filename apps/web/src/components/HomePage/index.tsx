            ...
            <div className="flex flex-row items-center justify-between gap-2 sm:gap-3 px-3 sm:px-6 py-3 sm:py-3 bg-background/70 backdrop-blur-md border border-foreground/10 rounded-xl sm:rounded-2xl shadow-2xl shadow-black/50">
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                >
                  ...
                  <span className="absolute inset-0 rounded-lg bg-gradient-to-r from-foreground via-foreground to-foreground opacity-70 group-hover:opacity-100 transition-opacity" />
                  <span className="absolute inset-[1px] rounded-[7px] bg-background/90 group-hover:bg-background/80 transition-colors" />

                  {/* Shimmer effect */}
                  <span className="absolute inset-0 rounded-lg bg-gradient-to-r from-transparent via-foreground/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out" />

                  {/* Content */}
                  <span className="relative flex items-center gap-2 text-foreground group-hover:text-foreground font-medium transition-colors">
              ...
              >
                <div className="flex flex-col gap-2">
                  ...
                  <a
                    href="/blog"
                    onClick={() => setMobileMenuOpen(false)}
                    className="w-full text-left px-4 py-3.5 bg-gradient-to-r from-foreground/20 to-foreground/20 hover:from-foreground/30 hover:to-foreground/30 text-foreground rounded-lg transition-all border border-foreground/30 min-h-[44px] flex items-center gap-2"
                  >
            ...
            >
              ...
              >
                <span className="flex items-center justify-center gap-2 sm:gap-3">
                  ...
                  <span className="truncate font-mono text-sm sm:text-base">npm i sui-cli-web-server</span>
