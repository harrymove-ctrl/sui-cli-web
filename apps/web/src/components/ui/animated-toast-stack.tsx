// Animated toast stack - adapted from beui.dev/components/motion/animated-toast-stack.
//
// This does NOT replace react-hot-toast, which the rest of the app uses for
// fire-and-forget confirmations ("Copied"). This one is for long-running CLI
// operations: it can morph a single toast loading -> success/error in place and
// hold a failure open with a Retry action.
//
// Only delta from the source: the success colour uses this project's `success`
// token rather than raw emerald.
